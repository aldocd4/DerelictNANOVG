...
#define NANOVG_GL_USE_STATE_FILTER (1)
	...
	NVGEXPORT NVGcontext* nvgCreateGL3(int flags);
	NVGEXPORT void nvgDeleteGL3(NVGcontext* ctx);

	NVGEXPORT int nvglCreateImageFromHandleGL3(NVGcontext* ctx, GLuint textureId, int w, int h, int flags);
	NVGEXPORT GLuint nvglImageHandleGL3(NVGcontext* ctx, int image);
